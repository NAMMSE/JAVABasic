...
public class S04_Event extends JFrame{
	public S04_Event() {
		...
		label.setHorizontalAlignment(SwingConstants.CENTER); // 라벨 텍스트 가운데 정렬하기
...
//				}
		...
		// MouseListener 처럼 너무 많은 메서드를 구현해야하는 인터페이스들을 위해 Adapter 클래스들이 존재한다
		...
		btn2.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				System.out.println("키보드를 눌렀다 뗐습니다!"+ e);
				System.out.println("방금 누른 문자 : "+e.getKeyChar());
				System.out.println("쉬프트가 눌려있나요?"+e.isShiftDown());
